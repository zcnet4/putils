...
namespace pmeta
{
    ...
    struct table
    {
        ...
        const Tuple& getKeyValues() const
        { return _tuple; }

        const FlatTuple& getFlatKeyValues() const
        { return _flatTuple; }
    ...
    namespace detail
    {
        ...
        template<std::size_t KPos, std::size_t VPos, typename Key, typename Table,
                                                     typename Func, std::size_t I, std::size_t ...Is>
